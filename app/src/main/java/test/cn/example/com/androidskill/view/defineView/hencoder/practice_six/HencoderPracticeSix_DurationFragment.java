...
public class HencoderPracticeSix_DurationFragment extends Fragment implements View.OnClickListener {
    private int mIndex;
    private View iv,iv2;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        switch (mIndex){
            case 0:
                LinearLayout ll = (LinearLayout) inflater.inflate(R.layout.fragment_hencode_practice_six_animation_duration,container,false);
                iv = ll.findViewById(R.id.iv);
                iv2 = ll.findViewById(R.id.iv2);
                ll.findViewById(R.id.btn_reset).setOnClickListener(this);
                ll.findViewById(R.id.btn_translationX_100ms).setOnClickListener(this);
                ll.findViewById(R.id.btn_translationXBy_100ms).setOnClickListener(this);

                ll.findViewById(R.id.btn_translationX_300ms).setOnClickListener(this);
                ll.findViewById(R.id.btn_translationX_500ms).setOnClickListener(this);

                ll.findViewById(R.id.btn_translationX_800ms).setOnClickListener(this);
    ...
    public void onClick(final View view) {
        ...
        switch (view.getId()){
            case R.id.btn_reset:
                ...
                break;
            case R.id.btn_translationX_100ms:
                viewPropertyAnimator.translationX(500).setDuration(100);
                viewPropertyAnimator2.translationX(500);
                break;
            case R.id.btn_translationXBy_100ms:
                viewPropertyAnimator.translationXBy(500).setDuration(100);
                viewPropertyAnimator2.translationXBy(500);
                break;
            case R.id.btn_translationX_300ms:
                viewPropertyAnimator.translationX(500).setDuration(300);
                viewPropertyAnimator2.translationX(500);
                break;
            case R.id.btn_translationX_500ms:
                viewPropertyAnimator.translationX(500).setDuration(500);
                viewPropertyAnimator2.translationX(500);
                break;
            case R.id.btn_translationX_800ms:
                viewPropertyAnimator.translationX(500).setDuration(800);
                viewPropertyAnimator2.translationX(500);
                break;

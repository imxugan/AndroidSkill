package test.cn.example.com.androidskill.common;
...
import test.cn.example.com.util.MD5Util;
...
//    public static final String REQUEST_SOURCE = (Application.APPLICATIONID.equals(BuildConfig.APPLICATION_ID))?"yyzs_ym":"yimai";
    public static final String REQUEST_SOURCE = "yimai";
...
//    public static final String REQUEST_PRO = (YMApplication.APPLICATIONID.equals(BuildConfig.APPLICATION_ID))?"xywyf32l24WmcqquqqTdhXaWkQ":"xywyf32l24WmcqquqqTdhXZ4kg";
    public static final String REQUEST_PRO = "xywyf32l24WmcqquqqTdhXZ4kg";
//    public static final String MD5_SIGN_KEY_VAULE = (YMApplication.APPLICATIONID.equals(BuildConfig.APPLICATION_ID))?"6F#KwNCrg.2BDc#+":"D@oQ8A*wte.bHFfA";
    public static final String MD5_SIGN_KEY_VAULE = "D@oQ8A*wte.bHFfA";

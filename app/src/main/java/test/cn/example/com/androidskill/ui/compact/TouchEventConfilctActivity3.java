...
/**
 * Android事件分发机制（下）解决滑动冲突
 * https://www.geek-share.com/detail/2772275180.html
 *
 * getParent().requestDisallowInterceptTouchEvent(boolean)
 * 这个方法是针对所有的父布局的，而不是只针对直接父布局
 * Created by xugan on 2019/7/16.
 */

public class TouchEventConfilctActivity3 extends AppCompatActivity {
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_touch_event_conflict3);

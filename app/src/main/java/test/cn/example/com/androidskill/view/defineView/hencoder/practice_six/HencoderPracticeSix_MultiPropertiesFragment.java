...
public class HencoderPracticeSix_MultiPropertiesFragment extends Fragment implements View.OnClickListener {
    private int mIndex;
    private View iv,iv2;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        LinearLayout ll = (LinearLayout) inflater.inflate(R.layout.fragment_hencode_practice_six_animation_multi,container,false);
        ...
        ll.findViewById(R.id.btn_tran_rotation_scale_alpha).setOnClickListener(this);
    ...
    public void onClick(final View view) {
        ...
        switch (view.getId()){
            case R.id.btn_reset:
                //将iv这个view移动到起始点
                viewPropertyAnimator.translationX(location[0]);
                viewPropertyAnimator2.translationX(location[0]);
                viewPropertyAnimator.rotation(0);
                viewPropertyAnimator2.rotation(0);
                viewPropertyAnimator.scaleX(1f);
                viewPropertyAnimator2.scaleX(1);
                viewPropertyAnimator.alpha(1f);
                viewPropertyAnimator2.alpha(1);
                break;
            case R.id.btn_tran_rotation_scale_alpha:
                viewPropertyAnimator.translationX(300).rotation(30).scaleX(1.5f).alpha(0.3f);
                break;
            ...
            case R.id.btn_AccelerateInterpolator:
                ...
                viewPropertyAnimator2.translationX(300).rotation(30).scaleX(1.5f).alpha(0.3f);
                break;

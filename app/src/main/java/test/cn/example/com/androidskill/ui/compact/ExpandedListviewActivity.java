...
public class ExpandedListviewActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ExpandedListviewActivity.MyAdapter myAdapter = new ExpandedListviewActivity.MyAdapter(this,data);
        recyclerView.setAdapter(myAdapter);
    }

    class MyAdapter extends RecyclerView.Adapter<ExpandedListviewActivity.MyViewHolder>{
        ...
        @NonNull
        @Override
        public ExpandedListviewActivity.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
            View view = LayoutInflater.from(mContext).inflate(R.layout.item_btn_recyclerview, viewGroup, false);
            ExpandedListviewActivity.MyViewHolder holder = new ExpandedListviewActivity.MyViewHolder(view);
            return holder;
        }

        @Override
        public void onBindViewHolder(@NonNull ExpandedListviewActivity.MyViewHolder myViewHolder, int i) {

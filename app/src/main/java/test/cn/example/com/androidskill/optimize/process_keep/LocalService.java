...
public class LocalService extends Service {
    ...
    private class MyServiceConnection implements ServiceConnection{
        ...
        public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            ...
            ToastUtils.shortToast(LocalService.this,componentName.getShortClassName()+"  建立连接");
        }

        @Override
        public void onServiceDisconnected(ComponentName componentName) {
            LogUtil.i(componentName.getShortClassName()+"  断开连接");
            ToastUtils.shortToast(LocalService.this,componentName.getShortClassName()+"  断开连接");
            //和远程RemoteService断开连接后，要重新启动远程的RemoteService

...
public class MyGradientView extends View {
    ...
    public MyGradientView(Context context, @Nullable @android.support.annotation.Nullable AttributeSet attrs) {
        super(context, attrs);
...
//        LogUtil.i("getWidth()="+getWidth()+"           getHeight()="+getHeight());
        ...
        canvas.drawCircle(min/2,min/2*scaleFloat,min/2,mPaint);

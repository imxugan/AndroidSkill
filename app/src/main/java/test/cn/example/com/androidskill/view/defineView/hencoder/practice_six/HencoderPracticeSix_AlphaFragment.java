...
public class HencoderPracticeSix_AlphaFragment extends Fragment implements View.OnClickListener {
    private int mIndex;
    private View iv,iv2;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        LinearLayout ll = (LinearLayout) inflater.inflate(R.layout.fragment_hencode_practice_six_animation_alpha,container,false);
        iv = ll.findViewById(R.id.iv);
        iv2 = ll.findViewById(R.id.iv2);
        ll.findViewById(R.id.btn_reset).setOnClickListener(this);
        ll.findViewById(R.id.btn_alpha).setOnClickListener(this);
        ll.findViewById(R.id.btn_alphaBy).setOnClickListener(this);
    ...
    public void onClick(final View view) {
        ...
        switch (view.getId()){
            case R.id.btn_reset:
                ...
                break;
            case R.id.btn_alpha:
                viewPropertyAnimator.alpha(0.3f);
                break;
            case R.id.btn_alphaBy:
                viewPropertyAnimator.alpha(0.3f);
                viewPropertyAnimator2.alphaBy(0.3f);
                break;
            ...
            case R.id.btn_AccelerateInterpolator:
                ...
                viewPropertyAnimator2.alpha(0.3f);
                break;

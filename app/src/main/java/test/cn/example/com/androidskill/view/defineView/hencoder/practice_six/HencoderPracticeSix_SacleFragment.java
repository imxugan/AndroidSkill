...
public class HencoderPracticeSix_SacleFragment extends Fragment implements View.OnClickListener {
    private int mIndex;
    private View iv,iv2;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        LinearLayout ll = (LinearLayout) inflater.inflate(R.layout.fragment_hencode_practice_six_animation_scale,container,false);
        iv = ll.findViewById(R.id.iv);
        iv2 = ll.findViewById(R.id.iv2);
        ll.findViewById(R.id.btn_reset).setOnClickListener(this);
        ll.findViewById(R.id.btn_scaleX).setOnClickListener(this);
        ll.findViewById(R.id.btn_scaleXBy).setOnClickListener(this);

        ll.findViewById(R.id.btn_scaleY).setOnClickListener(this);
        ll.findViewById(R.id.btn_scaleYBy).setOnClickListener(this);
    ...
    public void onClick(final View view) {
        ...
        switch (view.getId()){
            case R.id.btn_reset:
                ...
                viewPropertyAnimator2.scaleX(1).scaleY(1);
                break;
            case R.id.btn_scaleX:
                viewPropertyAnimator.scaleX(1.5f);
                break;
            case R.id.btn_scaleXBy:
                viewPropertyAnimator.scaleX(1.5f);
                viewPropertyAnimator2.scaleXBy(1.5f);
                break;
            case R.id.btn_scaleY:
                viewPropertyAnimator.scaleY(1.5f);
                break;
            case R.id.btn_scaleYBy:
                viewPropertyAnimator.scaleY(1.5f);
                viewPropertyAnimator2.scaleYBy(1.5f);
                break;
            ...
            case R.id.btn_AccelerateInterpolator:
                ...
                viewPropertyAnimator2.scaleX(1.5f);
                break;

...
import com.xywy.im.CustomerMessageObserver;
...
import com.xywy.im.tools.CustomerOutbox;
...
public class CustomerMessageActivity extends MessageActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        XywyIMService.getInstance().addCustomerServiceObserver(this);
    ...
    protected void onDestroy() {
        ...
        XywyIMService.getInstance().removeCustomerServiceObserver(this);
    ...
    void checkMessageFailureFlag(IMessage msg) {
        if (msg.sender == this.currentUID) {
            ...
            if (!msg.isAck() &&
                    !msg.isFailure() &&
                    !msg.getUploading() &&
                    !XywyIMService.getInstance().isCustomerMessageSending(msg.receiver, msg.msgLocalID)) {

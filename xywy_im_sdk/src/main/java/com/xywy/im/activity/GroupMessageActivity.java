...
import com.xywy.im.tools.GroupOutbox;
...
public class GroupMessageActivity extends MessageActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        XywyIMService.getInstance().addGroupObserver(this);
    ...
    protected void onDestroy() {
        ...
        XywyIMService.getInstance().removeGroupObserver(this);
    ...
    void checkMessageFailureFlag(IMessage msg) {
        if (msg.sender == this.currentUID) {
            ...
            if (!msg.isAck() &&
                    !msg.isFailure() &&
                    !msg.getUploading() &&
                    !XywyIMService.getInstance().isGroupMessageSending(groupID, msg.msgLocalID)) {

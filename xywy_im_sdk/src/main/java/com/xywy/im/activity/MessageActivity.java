...
import com.xywy.im.gallery.ui.GalleryUI;
...
import static com.xywy.im.constant.RequestCodes.SELECT_PICTURE_KITKAT;
import static com.xywy.im.constant.RequestCodes.TAKE_PICTURE;
...
//        listview.setAdapter(adapter);
        ...
        if (XywyIMService.getInstance().getConnectState() != XywyIMService.ConnectState.STATE_CONNECTED) {
//            disableSend();
        }
...
//                        break;
    ...
    protected void setSubtitle() {
        XywyIMService.ConnectState state = XywyIMService.getInstance().getConnectState();
        if (state == XywyIMService.ConnectState.STATE_CONNECTING) {
            setSubtitle("连线中");
        } else if (state == XywyIMService.ConnectState.STATE_CONNECTFAIL ||
                state == XywyIMService.ConnectState.STATE_UNCONNECTED) {
            setSubtitle("未连接");
        } else {
            setSubtitle("");
        }

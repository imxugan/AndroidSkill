...
//        }
        ...
        XywyIMService.getInstance().setCustomerMessageHandler(CustomerMessageHandler.getInstance());
        XywyIMService.getInstance().setToken(this.token);
        XywyIMService.getInstance().setDeviceID(this.deviceID);
